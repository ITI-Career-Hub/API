 ...
 */
public record ActivateAppointmentResponse(Long id, String appointmentName, LocalDate appointmentDate, InterviewType interviewType,
                                          String[] interviewers, Integer roomId, String roomName, String interviewNotes,
                                          Integer departmentId, String departmentName, Integer companyId,
