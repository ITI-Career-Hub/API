...
public record AddAppointmentRequest(String appointmentName, InterviewType interviewType, String[] interviewers,
                                    String interviewNotes, Integer departmentId, Integer companyId, Integer eventId,
